...
Pre-built binaries for Linux (amd64), macOS (arm64), and Windows
(amd64) are available from [GitHub Releases](https://github.com/devOpifex/builder/releases).
Download the archive for your platform, extract, and place the
